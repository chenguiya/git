...
var popup = {
	...
	open : function(pop, type, url) {
		...
		if(POPMENU[pop.attr('id')]) {
			...
			pop.parent().append('<div id="mask"><div class="dialogbox" id="'+ pop.attr('id') +'_popmenu" style="height:'+ pop.height() +'px;width:'+ pop.width() +'px;">'+ pop.html() +'</div></div>');
		}
		...
		$('#mask').css({'display':'block','width':'100%','height':'100%','position':'fixed','top':'0','left':'0','right':'0','bottom':'0','background':'rgba(0,0,0,.7)','z-index':'999999999'});
